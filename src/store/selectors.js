...
export const myFilledOrdersLoadedSelector = createSelector (filledOrdersLoaded, (loaded) => {return loaded});
...
export const myOpenOrdersLoadedSelector = createSelector(orderBookLoaded, (loaded) => {return loaded});
...
export const myOpenOrdersSelector = createSelector(
	...
	(account, orders) => {
		...
		// Decorete orders - add display attributes
...
export const priceChartLoadedSelector = createSelector(filledOrdersLoaded, (loaded) =>{return loaded});
...
const buildGraphData = (orders) => {
	...
	orders = groupBy(orders, (o) => moment.unix(o.timestamp).startOf('hours').format());
